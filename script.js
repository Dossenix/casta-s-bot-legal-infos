...
const translations = {
  it: {
    pageTitle: "Maggika | Legal Infos",
    metaDescription:
      "Terms of Service e Privacy Policy per Maggika, bot Discord.",
    ...
    "terms.1.body":
      "Utilizzando Maggika su Discord, accetti questi Terms of Service. Se non accetti questi termini, non utilizzare il bot e rimuovilo dai server in cui hai il permesso di gestire le applicazioni.",
    "terms.2.title": "2. Uso consentito",
    "terms.2.body":
      'Maggika deve essere usato nel rispetto delle regole di Discord, incluse le <a href="https://discord.com/terms" target="_blank" rel="noreferrer">Terms of Service di Discord</a>, le policy per sviluppatori, le leggi applicabili e le regole del server in cui viene installato. Non e\' consentito usare il bot per spam, molestie, abuso, elusione di sistemi di moderazione, raccolta non autorizzata di dati o attivita\' dannose verso utenti, server o servizi terzi.',
    ...
    "privacy.1.body":
      "Maggika puo' trattare dati tecnici e dati Discord necessari al funzionamento del bot, come ID utente, ID server, ID canali, ruoli, impostazioni del server, comandi usati, timestamp, log tecnici e contenuti inviati dagli utenti quando sono necessari per eseguire una funzione richiesta.",
  ...
  en: {
    pageTitle: "Maggika | Legal Infos",
    metaDescription:
      "Terms of Service and Privacy Policy for Maggika, a Discord bot.",
    ...
    "terms.1.body":
      "By using Maggika on Discord, you agree to these Terms of Service. If you do not agree to these terms, do not use the bot and remove it from any servers where you have permission to manage applications.",
    "terms.2.title": "2. Permitted use",
    "terms.2.body":
      'Maggika must be used in compliance with Discord rules, including the <a href="https://discord.com/terms" target="_blank" rel="noreferrer">Discord Terms of Service</a>, developer policies, applicable laws, and the rules of the server where it is installed. You may not use the bot for spam, harassment, abuse, bypassing moderation systems, unauthorized data collection, or harmful activity against users, servers, or third-party services.',
    ...
    "privacy.1.body":
      "Maggika may process technical data and Discord data required for the bot to operate, such as user IDs, server IDs, channel IDs, roles, server settings, used commands, timestamps, technical logs, and content sent by users when needed to perform a requested feature.",
...
function readSavedLanguage() {
  try {
    return localStorage.getItem("maggikaLegalLanguage");
  } catch {
    return null;
  }
}
...
function saveLanguage(language) {
  try {
    localStorage.setItem("maggikaLegalLanguage", language);
  } catch {
    return;
  }
}
